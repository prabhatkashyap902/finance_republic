...
This is the main activity where all the stocks is displayed.
I have taken the csv file converted it into JSON online and used as assets in the android studio.
